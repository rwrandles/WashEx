...
setwd("C:/Users/Rohnin/Documents/R Stuff/WashEx_8_2_19/") ## Set working directory to location of WashEx folder
...
for(biennium in biennium_list){
  ...
  for(bill in 7697:nrow(year_bills)){
...
for(bill in 4518:nrow(master_bills)){
...
WashEx <- dbConnect(RSQLite::SQLite(), dbname = "./OUTPUT/WashEx-db.sqlite")
