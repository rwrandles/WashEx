...
## Function: make_mysql_compatible
## Arguments: data_frame - any data frame to be formatted
##
## Returns: returns the same data frame properly formatted in mySQL to be compatible with Amazon Relational Databases
...
## Function: houseSwap
## Arguments: agency - the initial of a branch of the legislature ("H" or "S")
##
## Returns: returns a character vector containing the opposite branch
