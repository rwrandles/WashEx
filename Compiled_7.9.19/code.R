...
setwd("C:/Users/Rohnin/Documents/R Stuff/WashEx_7_9_19/OUTPUT") ## Set working directory to location of WashEx folder
...
master_bills <- master_bills %>% select(BillId, BillNumber, 
                                        ...
                                        Biennium, LegalTitle, IntroducedDate, Sponsor, PrimeSponsorID, LongDescription)
